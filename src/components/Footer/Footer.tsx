              ...
              <div className="space-y-5 rounded-lg bg-gray-50 p-6 dark:bg-gray-700">
                ...
                <form action="#">
                  <div className="items-end space-y-4 sm:flex sm:space-y-0">
                    <div className="relative mr-3 w-full sm:w-96 lg:w-full">
                      ...
                      <input
                        className="focus:border-primary-500 focus:ring-primary-500 dark:focus:border-primary-500 dark:focus:ring-primary-500 block w-full rounded-lg border border-gray-300 bg-white p-3 text-sm text-gray-900 sm:w-96 lg:w-full dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400"
                ...
                <div>
                  ...
                  <div className="gap-4 space-y-4 sm:flex sm:space-y-0">
                    <a
                      href="#"
                      className="inline-flex w-full items-center justify-center rounded-lg bg-gray-800 px-4 py-2.5 text-white hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 focus:outline-none sm:w-auto dark:bg-gray-600 dark:hover:bg-gray-500 dark:focus:ring-gray-800"
                    >
                      <svg
