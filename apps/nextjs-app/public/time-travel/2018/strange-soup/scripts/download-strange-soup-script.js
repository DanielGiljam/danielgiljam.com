...
switch (clientOS) {
    case "Windows":
        ...
        document.getElementById("download-trigger").setAttribute("src", "binaries/strange-soup-installer.exe");
        break;
    case "Mac OS":
        document.getElementById("paragraph-2").setAttribute("style", "display: block");
        console.log("Initiating download of strange-soup-installer.dmg...");
        document.getElementById("download-trigger").setAttribute("src", "binaries/strange-soup-installer.dmg");
        break;
    default:
        document.getElementById("strange-soup-image").setAttribute("src", "media-content/strange-soup-image-1.png");
